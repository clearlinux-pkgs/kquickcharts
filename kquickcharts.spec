...
Version  : 6.1.0
Release  : 56
URL      : https://download.kde.org/stable/frameworks/6.1/kquickcharts-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/kquickcharts-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kquickcharts-6.1.0.tar.xz.sig
...
%setup -q -n kquickcharts-6.1.0
cd %{_builddir}/kquickcharts-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712955102
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQuickCharts.so.6.1.0
/V3/usr/lib64/libQuickChartsControls.so.6.1.0
...
/usr/lib64/libQuickCharts.so.6.1.0
/usr/lib64/libQuickChartsControls.so.1
/usr/lib64/libQuickChartsControls.so.6.1.0
