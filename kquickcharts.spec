...
Version  : 6.14.0
Release  : 72
URL      : https://download.kde.org/stable/frameworks/6.14/kquickcharts-6.14.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.14/kquickcharts-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/kquickcharts-6.14.0.tar.xz.sig
...
%setup -q -n kquickcharts-6.14.0
cd %{_builddir}/kquickcharts-6.14.0
pushd ..
cp -a kquickcharts-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747166768
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQuickCharts.so.6.14.0
/V3/usr/lib64/libQuickChartsControls.so.6.14.0
...
/usr/lib64/libQuickCharts.so.6.14.0
/usr/lib64/libQuickChartsControls.so.1
/usr/lib64/libQuickChartsControls.so.6.14.0
