...
Version  : 6.11.0
Release  : 69
URL      : https://download.kde.org/stable/frameworks/6.11/kquickcharts-6.11.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.11/kquickcharts-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/kquickcharts-6.11.0.tar.xz.sig
...
%setup -q -n kquickcharts-6.11.0
cd %{_builddir}/kquickcharts-6.11.0
pushd ..
cp -a kquickcharts-6.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739570174
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/cmake/KF6QuickCharts/KF6QuickChartsTargets-relwithdebinfo.cmake
/usr/lib64/cmake/KF6QuickCharts/KF6QuickChartsTargets.cmake
/usr/lib64/libQuickCharts.so
/usr/lib64/libQuickChartsControls.so

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQuickCharts.so.6.11.0
/V3/usr/lib64/libQuickChartsControls.so.6.11.0
...
/usr/lib64/libQuickCharts.so.6.11.0
/usr/lib64/libQuickChartsControls.so.1
/usr/lib64/libQuickChartsControls.so.6.11.0
