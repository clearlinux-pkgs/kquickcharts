...
Version  : 5.107.0
Release  : 42
URL      : https://download.kde.org/stable/frameworks/5.107/kquickcharts-5.107.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.107/kquickcharts-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/kquickcharts-5.107.0.tar.xz.sig
...
%prep
%setup -q -n kquickcharts-5.107.0
cd %{_builddir}/kquickcharts-5.107.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686534752
mkdir -p clr-build
pushd clr-build
