...
%setup -q -n kquickcharts-6.2.0
cd %{_builddir}/kquickcharts-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715626606
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQuickCharts.so.6.2.0
/V3/usr/lib64/libQuickChartsControls.so.6.2.0
...
/usr/lib64/libQuickCharts.so.6.2.0
/usr/lib64/libQuickChartsControls.so.1
/usr/lib64/libQuickChartsControls.so.6.2.0
