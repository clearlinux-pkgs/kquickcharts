...
Version  : 5.115.0
Release  : 51
URL      : https://download.kde.org/stable/frameworks/5.115/kquickcharts-5.115.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.115/kquickcharts-5.115.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.115/kquickcharts-5.115.0.tar.xz.sig
...
%prep
%setup -q -n kquickcharts-5.115.0
cd %{_builddir}/kquickcharts-5.115.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707700716
mkdir -p clr-build
pushd clr-build
