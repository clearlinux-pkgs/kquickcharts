...
Source0  : https://download.kde.org/stable/frameworks/5.108/kquickcharts-5.108.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.108/kquickcharts-5.108.0.tar.xz.sig
...
%prep
%setup -q -n kquickcharts-5.108.0
cd %{_builddir}/kquickcharts-5.108.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688870860
mkdir -p clr-build
pushd clr-build
