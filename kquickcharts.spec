...
Version  : 5.67.0
Release  : 1
URL      : https://download.kde.org/stable/frameworks/5.67/kquickcharts-5.67.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.67/kquickcharts-5.67.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.67/kquickcharts-5.67.0.tar.xz.sig
...
%prep
%setup -q -n kquickcharts-5.67.0
cd %{_builddir}/kquickcharts-5.67.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581817814
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kquickcharts-5.67.0/COPYING %{buildroot}/usr/share/package-licenses/kquickcharts/f085cbddad67ee4a8457fad05c4b449b4e731d95
pushd clr-build
%make_install
popd
